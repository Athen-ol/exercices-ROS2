...
bool tutorial_interfaces__msg__msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.msg._msg.Msg", full_classname_dest, 32) == 0);
  }
  tutorial_interfaces__msg__Msg * ros_message = _ros_message;
  {  // computer_name
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * tutorial_interfaces__msg__msg__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Msg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.msg._msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Msg");
  ...
  tutorial_interfaces__msg__Msg * ros_message = (tutorial_interfaces__msg__Msg *)raw_ros_message;
  {  // computer_name
    PyObject * field = NULL;
