...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tutorial_interfaces.srv.AddTwoInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tutorial_interfaces.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from tutorial_interfaces.srv._add_two_ints import AddTwoInts_Request as Request
    from tutorial_interfaces.srv._add_two_ints import AddTwoInts_Response as Response
