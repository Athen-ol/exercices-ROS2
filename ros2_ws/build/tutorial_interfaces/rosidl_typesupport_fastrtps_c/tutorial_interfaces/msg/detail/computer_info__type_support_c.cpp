...
#include "tutorial_interfaces/msg/detail/computer_info__rosidl_typesupport_fastrtps_c.h"
...
using _ComputerInfo__ros_msg_type = tutorial_interfaces__msg__ComputerInfo;
...
size_t get_serialized_size_tutorial_interfaces__msg__ComputerInfo(
  const void * untyped_ros_message,
...
static uint32_t _ComputerInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__msg__ComputerInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__msg__ComputerInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interfaces__msg__ComputerInfo;
    is_plain =
      (
...
static size_t _ComputerInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces__msg__ComputerInfo(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, msg, ComputerInfo)() {
