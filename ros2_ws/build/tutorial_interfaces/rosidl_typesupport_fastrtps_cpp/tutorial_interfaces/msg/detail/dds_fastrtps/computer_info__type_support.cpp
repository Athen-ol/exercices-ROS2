...
#include "tutorial_interfaces/msg/detail/computer_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::msg::ComputerInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::msg::ComputerInfo & ros_message)
{
  // Member: computer_name
  cdr >> ros_message.computer_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interfaces::msg::ComputerInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::ComputerInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::ComputerInfo *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_ComputerInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, ComputerInfo)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_ComputerInfo__handle;
}
