...
{
  new (message_memory) tutorial_interfaces::msg::ComputerInfo(_init);
}

void ComputerInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_interfaces::msg::ComputerInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ComputerInfo_message_member_array[3] = {
  {
    ...
    offsetof(tutorial_interfaces::msg::ComputerInfo, computer_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces::msg::ComputerInfo, domain_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces::msg::ComputerInfo, counter),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ComputerInfo_message_members = {
  ...
  3,  // number of fields
  sizeof(tutorial_interfaces::msg::ComputerInfo),
...
get_message_type_support_handle<tutorial_interfaces::msg::ComputerInfo>()
{
  return &::tutorial_interfaces::msg::rosidl_typesupport_introspection_cpp::ComputerInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, msg, ComputerInfo)() {
  return &::tutorial_interfaces::msg::rosidl_typesupport_introspection_cpp::ComputerInfo_message_type_support_handle;
}
