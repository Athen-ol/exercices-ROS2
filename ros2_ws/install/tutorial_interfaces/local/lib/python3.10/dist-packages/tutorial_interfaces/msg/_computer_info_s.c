...
bool tutorial_interfaces__msg__computer_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.msg._computer_info.ComputerInfo", full_classname_dest, 51) == 0);
  }
  tutorial_interfaces__msg__ComputerInfo * ros_message = _ros_message;
  {  // computer_name
...
PyObject * tutorial_interfaces__msg__computer_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.msg._computer_info");
